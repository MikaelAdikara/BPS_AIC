...
| 2 | Model teks — fine-tuning IndoBERT | 🔄 berjalan | menunggu: macro F1 > baseline |
| 3 | Model visual — zero-shot CLIP, threshold, kalibrasi | ⬜ belum | **gate kritis** — go/no-go berbasis selective accuracy aktual |
